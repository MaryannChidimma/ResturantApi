  ...
  <mj-body>
    <mj-section>
      <mj-column>
        ...
        <mj-text>Please Enter The 7 Digit Token Below</mj-text>
        <mj-text>{{token}}</mj-text>
...
const replyMessage = mjml2html(`<mjml>
 ...
 <mj-body>
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="20px"
                 font-family="helvetica">{{message}}</mj-text>
...
let replyMessageMail = Handlebars.compile(replyMessage.html)
